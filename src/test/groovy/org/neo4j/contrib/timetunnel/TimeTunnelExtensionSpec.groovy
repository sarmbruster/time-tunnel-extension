...
class TimeTunnelExtensionSpec extends Specification {
    ...
    static SIMPLE_GRAPH_RESULT = [[name:'Jim', labels:['Person'], from: "2010-01-01", to: "2014-12-31"]]
    ...
    """
    static OVERLAPPING_SIMPLE_RESULT = [[name:'Jim', labels:['Person'], from: "2010-01-01", to: "2014-12-31"], [name:'Simon', labels:['Person'], from: '2011-01-01', to:'2014-12-31']]
    ...
    """
    static NON_OVERLAPPING_SIMPLE_RESULT = [[name:'Jim', labels:['Person'], from: "2010-01-01", to: "2014-12-31"]]
    ...
    def "should find time tunnel"() {
        ...
        when:
        def result = cut.findPathsWithTimeTunnel("Person", "name", "John", ["WORKED_WITH"], ["name"], "from", "to", "yyyy-MM-dd")
